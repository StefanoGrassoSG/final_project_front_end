            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="services">
                        ...
                        <ul>
                            <li class="fs-5" v-for="singleService in singleApt.services" :key="index">
                                {{ singleService.name }}
                            </li>
                        </ul>
                    </div>
                ...
                <div class="apt-card-dx col-md-6 col-sm-12 border rounded-4 px-4">
                        ...
                        <div class="card-body card-info-apt">
                            <div class="row">
                                <div class="col d-flex justify-content-center">
                                    <button type="submit" class="m-auto btn-contact">
                                        Contatta l'host
                                    </button>
                                </div>
                            </div>
